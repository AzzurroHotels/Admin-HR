(async()=>{
  ...
  Shared.shell('user-management','User Management','Create and manage Admin and Manager accounts. New accounts can only be created from this page.');
    ...
    <div class="user-management-grid">
      <form id="userForm" class="panel user-form-card">
        <div class="panel-body">
          ...
          <div class="field"><label>Role</label><select id="userRole"><option value="Manager">Manager</option><option value="Admin">Admin</option></select></div>
          ...
          <div class="role-help">
            ...
            <p><strong>Manager:</strong> Staff Management view access only, plus permission to create and save new Reception evaluations.</p>
          </div>
        </div>
      </form>
      <div>
