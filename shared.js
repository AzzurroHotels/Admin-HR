...
function shell(active,title,description){
  const adminNav=[
    ...
    ['cleaners-task-monitoring',"Cleaner's Task Monitoring"],
    ['staff','Staff Management'],
    ['rostering','Rostering'],
    ['published-roster','Published Roster'],
    ['user-management','User Management']
  ];
  const managerNav=[['cleaners-task-monitoring',"Cleaner's Task Monitoring"],['staff','Staff Management'],['rostering','Rostering'],['published-roster','Published Roster'],['user-management','User Management']];
  const cleanerRosterNav=[['rostering','Cleaner Rostering'],['published-roster','Published Roster']];
  const nav=Auth.user?.role==='Manager'?managerNav:(Auth.user?.role==='Cleaner Roster Manager'?cleanerRosterNav:adminNav);
